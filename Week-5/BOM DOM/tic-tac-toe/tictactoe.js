...
function newGame() {
	...
	// document.getElementById("gameBoard").innerHTML = "<button></button><button></button><button></button><button></button><button></button><button></button><button></button><button></button><button></button>";
...
function switchTurn() {
	...
	if(result == 1){
		...
		if(playerTurn){
			...
			computerMoveTimeout = setTimeout(makeComputerMove() , 10000);
